...
#Region "Custom Selenium functions"
    ...
    Public Function ta_REG_submit_valid_new_account_email(ByVal mcpParameters() As Object) As Object()
        ...
        Try
            ...
            Dim sMessageText As String = "We searched our system for any account that matches the Email address or Membership ID number that you entered. No matching accounts were identified. Please click Register to create a new user account."
